...
public class NotaFiscalBCTest {
	...
	public void testInsert() {
		...
		NotaFiscal notaFiscal = new NotaFiscal("chaveNfe", "naturezaOperacao",
				"modelo", "serie", "numero", new Date(), "tipoEmissao", null,
				null, null, null);
	...
	public void testUpdate() {
		...
		notaFiscal2.setNaturezaOperacao("novo valor");
		...
		// alterar para tratar uma propriedade existente na Entidade NotaFiscal
		assertEquals("novo valor", notaFiscal3.getNaturezaOperacao());
	}
