...
public class EmitenteBCTest {
	...
	public void testInsert() {
		...
		Emitente emitente = new Emitente("documento","nome","inscricaoEstadual",null);
	...
	public void testUpdate() {
		...
		// emitente2.setUmaPropriedade("novo valor");
		...
		// alterar para tratar uma propriedade existente na Entidade Emitente
		// assertEquals("novo valor", emitente3.getUmaPropriedade());
	}
